...
class LoginForm(forms.Form):
    ...
    username = forms.CharField(max_length=50,widget=forms.EmailInput(attrs={'class':'form-control form-control-lg',
...
class RegisterForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if Profile.objects.filter(phone_num=phone_num).exists():
            ...
            self.add_error('phone_num','This phone number already taken')
...
class NewPasswordForm(forms.Form):
    ...
    def clean(self):
        ...
        if password != confirm_password:
            ...
            self.add_error('confirm_password','Passwords are mismatch')